...
protocol ReferDelegate {
    func removeTapAt(index:Int)
    func addMoreTapAt(index:Int)
    func getName(name:String,index:Int)
    func getemail(name:String,index:Int)
    func getMobile(name:String,index:Int)
}
...
extension ReferCell:UITextFieldDelegate{
